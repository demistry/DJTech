...
import com.djtech.android.adapters.TeamRecyclerAdapter;
import com.djtech.android.ui.fragments.ProfilePictureFragment;
...
public class TeamMembersActivity extends AppCompatActivity {
    ...
    private int [] images = {R.drawable.david_2,R.drawable.john_esan,R.drawable.paul,R.drawable.marvex2,
